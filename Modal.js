    ...
    >
      <Box sx={{
        ...
        <Grid container height={'100%'}>
          <Grid item sm={6} xs={12} py={10} px={{ sm: 10, xs: 4 }} 
            display={'flex'}
          ...
          >
            ...
            />
            <Box component={'img'} src={logo} alt='' sx={{
          ...
          <Grid item sm={6} xs={12} py={10} px={{ sm: 10, xs: 4 }}
            ...
            sx={{ background: 'black' }}
          >
            <Box display={{ sm: 'block', xs: 'none' }} sx={{
              position: 'relative',
            }}>
              <Box component={'img'}
                src={closeIcon} alt='' 
            ...
            <Box>
              ...
              <Box display={'flex'} justifyContent={'center'} mt={6}>
                <Box display={'flex'} alignItems={'center'} gap={3}>
                  <Box component={'img'} src={placeholder1} alt='' sx={{
                    width: '20px',
                  }} />
                  <Typography variant='h4' sx={{
                    color: '#F7FBFA'
                  }}>Scan to connect</Typography>
                </Box>
              </Box>
            </Box>
